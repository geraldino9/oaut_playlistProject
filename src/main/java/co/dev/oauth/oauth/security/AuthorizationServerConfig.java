...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    @Autowired
    private AuthenticationManager autneticationManager;
    ...
    public void configure(AuthorizationServerEndpointsConfigurer endpoints) throws Exception {
        ...
        tokenEnhancerChain.setTokenEnhancers(Arrays.asList( accestokenConverter(), infoAdicionalToken));
        endpoints.authenticationManager(autneticationManager)
